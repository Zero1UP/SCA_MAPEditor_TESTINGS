...
namespace SOCOMCA_MAP_Editor
{
    class CA_Archive
    {
        ...
        public int GetFileIndex(String FileName)
        {
            ...
            if (ArchiveOpen == 1)
            {
                for (i = 0; i < ArchiveFiles1.Count(); i++)
                {
                    if (ArchiveFiles1[i].FullPath == FileName)
                        return i;
                    //Console.Write(ArchiveFiles1[i].FullPath + "\n");
                }
            }
            else if (ArchiveOpen == 2)
            {
                for (i = 0; i < ArchiveFiles2.Count(); i++)
                {
                    if (ArchiveFiles2[i].FullPath == FileName)
                        return i;
                    //Console.Write(ArchiveFiles2[i].FullPath + "\n");
                }
            }
